...
Build-Depends: autoconf, binutils (>= 2.17cvs20070426-1), bzip2, debhelper (>= 5.0), dpkg-dev (>= 1.13.5), file, g++-4.2 (>= 4.2.3) [alpha hppa hurd-i386], g++-4.2-multilib [kfreebsd-amd64], g++-4.3 (>= 4.3.0) [!alpha !hppa !hurd-i386], g++-4.3-multilib [amd64 i386 kfreebsd-amd64 mips mipsel powerpc ppc64 s390 sparc], gawk, gettext, gnumach-dev [hurd-i386], hurd-dev (>= 20020608-1) [hurd-i386], kfreebsd-kernel-headers [kfreebsd-i386 kfreebsd-amd64], libpthread-stubs0-dev [hurd-i386], linux-libc-dev [!hurd-i386 !kfreebsd-i386 !kfreebsd-amd64], make (>= 3.80-1), mig (>= 1.3-2) [hurd-i386], quilt, sed (>= 4.0.5-4), texi2html, texinfo (>= 4.0)
Build-Depends-Indep: perl, po-debconf (>= 1.0)
Files: 
 94ce5d510592f8176d8d8c53cdb01c9d 16230840 glibc_2.8~20080505.orig.tar.gz
 7bc3c83c37e2ad8687d98251d5250a20 779164 glibc_2.8~20080505-0ubuntu2.diff.gz
Original-Maintainer: GNU Libc Maintainers <debian-glibc@lists.debian.org>

-----BEGIN PGP SIGNATURE-----
Version: GnuPG v1.4.6 (GNU/Linux)

iD8DBQFIJahDStlRaw+TLJwRAmthAKC4lx9GGrsHTz9botYdSLydN63rlwCeNY7L
5RhWESAslQn34lLUmB8h0+Q=
=yM8N
-----END PGP SIGNATURE-----
