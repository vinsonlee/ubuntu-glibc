...
GLIBC_PASSES += sparc64v2
DEB_ARCH_REGULAR_PACKAGES += libc6-sparc64v2
sparc64v2_add-ons = nptl $(add-ons)
sparc64v2_configure_build=sparc64-linux
sparc64v2_configure_target=sparc64v2-linux
sparc64v2_CC = $(BUILD_CC) -m64 -mcpu=niagara2
sparc64v2_CXX = $(BUILD_CXX) -m64 -mcpu=niagara2
...
sparcv9v2_configure_target=sparcv9v2-linux
