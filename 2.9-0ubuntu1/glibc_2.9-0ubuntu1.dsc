...
Build-Depends: gettext, make (>= 3.80), dpkg-dev (>= 1.14.17), bzip2, lzma, file, quilt, texinfo (>= 4.0), texi2html, autoconf, sed (>= 4.0.5-4), gawk, debhelper (>= 5.0), linux-libc-dev [!hurd-i386 !kfreebsd-i386 !kfreebsd-amd64], mig (>= 1.3-2) [hurd-i386], hurd-dev (>= 20080607-3) [hurd-i386], gnumach-dev [hurd-i386], libpthread-stubs0-dev [hurd-i386], kfreebsd-kernel-headers [kfreebsd-i386 kfreebsd-amd64], binutils (>= 2.19-0ubuntu3), g++-4.2 (>= 4.2.1) [alpha sparc], g++-4.2-multilib [sparc], g++-4.3 (>= 4.3.2-2ubuntu5) [!alpha !sparc], g++-4.3-multilib [amd64 i386 kfreebsd-amd64 mips mipsel powerpc ppc64 s390]
Build-Depends-Indep: perl, po-debconf (>= 1.0)
Checksums-Sha1: 
 4f7c5cb1327a1e56970707e6017f61464ead91d3 23036779 glibc_2.9.orig.tar.gz
 9ebd34019df02dae40419e1abd2ee4602f6e1273 2666802 glibc_2.9-0ubuntu1.diff.gz
Checksums-Sha256: 
 5c2f63baea1ecdf647e477b9ff609bbe551eef5a3878f265d2cd9bd7fb7d041a 23036779 glibc_2.9.orig.tar.gz
 8aac0dbd63d4f79e6b269024946032962aa44b8ed029703382092615ca303654 2666802 glibc_2.9-0ubuntu1.diff.gz
Files: 
 926e90e50fe4f830575fef1c6a554768 23036779 glibc_2.9.orig.tar.gz
 4a352846726c9a7b0b6072315cac40da 2666802 glibc_2.9-0ubuntu1.diff.gz
Original-Maintainer: GNU Libc Maintainers <debian-glibc@lists.debian.org>

-----BEGIN PGP SIGNATURE-----
Version: GnuPG v1.4.9 (GNU/Linux)

iEYEARECAAYFAkkxUQgACgkQStlRaw+TLJxrsQCeKw2TlkVCIYICf2zZY5lTacmb
LqoAn3IDDWd/6/BgqHBR4zK1taC07/uQ
=pL+M
-----END PGP SIGNATURE-----
